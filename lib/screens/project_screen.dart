      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: StreamBuilder(
            ...
            stream:
                Provider.of<ProjectsHandler>(context, listen: false).getStream,
            builder: (context, AsyncSnapshot snapshot) {
              try {
                if (Provider.of<ProjectsHandler>(context).getCurrentUser ==
                    null) {
                ...
                return Stack(alignment: Alignment.center, children: [
                  Visibility(
                    ...
                    child:
                        Lottie.asset(paths[Paths.lottieLoading]!, repeat: true),
                  ),
                  Column(
                              ...
                              child: DragAndDropLists(
                                ...
                                onItemReorder: (int oldItemIndex,
                                  ...
                                  setState(() {
                                    ...
                                    data[oldBoardName].removeAt(oldItemIndex);
                ...
                return Lottie.asset(paths[Paths.lottieLoading]!, repeat: true);
              }
            },
          ),
        ),
